...
public:
	...
	BULLET_STATE GetState() const { return m_State; }
	void SetState(BULLET_STATE state) { m_State = state; }

public:
	bool IsCanFire() const { return m_State != BULLET_STATE::Fired; }
	void Fire(XMFLOAT3 xmf3Position);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
#define EXPLOSION_NUM_LIMIT 20
class CExplosionShader; 
class CExplosion : public CGameObject
{
public:
	CExplosion(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, XMFLOAT3 xmf3Position);
	virtual ~CExplosion();
...
private: 
	...
	float					m_fAnimationTimeSum = 0.0f;
	float					m_fTimeSum = 0.0f;

	int						m_nAnimaionIndex = 0;
