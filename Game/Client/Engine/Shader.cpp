...
void Shader::CreateGraphicsShdaer(const wstring& path, ShaderInfo info, const string& vs, const string& ps)
{
	_shaderInfo = info;
	...
	_graphicsPipelineDesc.PrimitiveTopologyType = _shaderInfo.topologyType;
