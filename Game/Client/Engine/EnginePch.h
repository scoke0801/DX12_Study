...
#define GRAPHICS_CMD_LIST GEngine->GetGraphicsCommandQueue()->GetCommandList()
#define COMPUTE_CMD_LIST GEngine->GetComputeCommandQueue()->GetCommandList()
#define RESOURCE_CMD_LIST GEngine->GetGraphicsCommandQueue()->GetResourceCommandList()
