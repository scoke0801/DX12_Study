...
void __DX12Engine::Texture::Load(const wstring& path)
{
	//// 파일 확장자 얻기
	...
	//ENGINE->GetCommandQueue(CommandQueueType::RESOURCE);
	//ENGINE->GetGraphicsCmdQueue()->FlushResourceCommandQueue();
