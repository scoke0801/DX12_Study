...
void __DX12Engine::RootSignature::Init()
{
	CreateGraphicsRootSignature();
	CreateComputeRootSignature();
}

void __DX12Engine::RootSignature::CreateGraphicsRootSignature()
{
...
void __DX12Engine::RootSignature::CreateComputeRootSignature()
{
	//CD3DX12_DESCRIPTOR_RANGE ranges[] =
	//{
