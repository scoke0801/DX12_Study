...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[3].BaseShaderRegister = 3; //t3: gtxtWaterBaseTexture, t4: gtxtWaterDetailTexture, t5: gtxtWaterDetailAlphaTexture
	pd3dDescriptorRanges[3].RegisterSpace = 0;
	pd3dDescriptorRanges[3].OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;

	pd3dDescriptorRanges[4].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[4].NumDescriptors = 1;
	pd3dDescriptorRanges[4].BaseShaderRegister = 6; //t6: gtxtSkyBoxTexture
	...
	pd3dRootParameters[5].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[3];//t3: gtxtWaterBaseTexture, t4: gtxtWaterDetailTexture, t5: gtxtWaterDetailAlphaTexture
...
void CScene::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pd3dCommandList->SetGraphicsRoot32BitConstants(8, 16, &xmf4x4WaterAnimation, 0);
}
